...
public class LendingBean {
	...
	public LendingBean(int lendingId,Date lendingLendDate,Date lendingReturnDate,Date insertDate,int insertEmployeeId,int usersId,int booksId, String booksName, String booksAuthor) {
